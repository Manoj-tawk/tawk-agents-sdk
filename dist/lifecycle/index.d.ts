 ...
 */
export declare class AgentHooks<TContext = any, TOutput = string> extends EventEmitter {
    /**
 ...
 */
export declare class RunHooks<TContext = any, TOutput = string> extends EventEmitter {
    /**
     * Register a handler for agent_start event
     */
