...
exports.createTransferTools = createTransferTools;
exports.detectTransfer = detectTransfer;
exports.extractUserQuery = extractUserQuery;
exports.createTransferContext = createTransferContext;
 ...
 */
function createTransferTools(agent, subagents) {
    const tools = {};
    for (const subagent of subagents) {
        ...
        tools[toolName] = {
            ...
            inputSchema: zod_1.z.object({
                reason: zod_1.z.string().describe('Reason for transferring to this agent'),
                query: zod_1.z.string().optional().describe('Specific query for the agent (if different from original)')
            }),
 ...
 */
function detectTransfer(toolResults, currentAgent) {
 ...
 */
function createTransferContext(fromAgent, toAgent, reason) {
